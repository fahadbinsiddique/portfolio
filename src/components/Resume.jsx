  ...
  return (
    ...
    >
        ...
        {[
          {
            ...
            text: "fahadbinsiddique0@gmail.com",
            href: "mailto:fahadbinsiddique0@gmail.com",
          },
          {
            icon: <FaGithub className="text-purple-400" />,
            text: "GitHub",
            href: "https://github.com/fahadbinsiddique",
          },
          {
            icon: <FaLinkedin className="text-purple-400" />,
            text: "LinkedIn",
            href: "https://linkedin.com/in/fahadbinsiddique",
          },
          {
            icon: <FaGlobe className="text-purple-400" />,
            text: "Portfolio",
            href: "https://fahads.vercel.app",
          },
          {
      ...
      >
        ...
        >
          Passionate Frontend Developer with expertise in modern JavaScript
          frameworks. Dedicated to crafting responsive, accessible, and
          performant web applications. Seeking opportunities to contribute
          innovative solutions while growing in a collaborative environment.
        </motion.p>
      </motion.div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-gray-300 mt-2">
              Full-featured eCommerce platform with user authentication, product
              management, and payment integration.
            </p>
            <div className="mt-4 flex flex-wrap gap-2">
              {["React", "Firebase", "JabaScript"].map((tech, index) => (
                <motion.span
                  key={index}
            ...
            <div className="mt-4 flex gap-4">
              ...
              <motion.a
                href="https://fahadone.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-400 hover:text-purple-300 transition-colors flex items-center gap-1"
                whileHover={{ x: 3 }}
          ...
          >
            ...
            <p className="text-gray-300 mt-2">
              A modern and interactive Tic Tac Toe game built with React.js and
              Tailwind CSS, featuring move history tracking and winner/draw
              detection.
            </p>
            <div className="mt-4 flex flex-wrap gap-2">
              {["HTML", "Tailwind CSS", "JabaScript"].map((tech, index) => (
                <motion.span
                  key={index}
                  className="px-3 py-1 bg-purple-900/50 text-purple-300 rounded-full text-sm"
                  whileHover={{ scale: 1.1 }}
            ...
            <div className="mt-4 flex gap-4">
              <motion.a
                href="https://github.com/fahadbinsiddique/tictac"
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-400 hover:text-purple-300 transition-colors flex items-center gap-1"
                whileHover={{ x: 3 }}
              ...
              <motion.a
                href="https://fahadfive.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-400 hover:text-purple-300 transition-colors flex items-center gap-1"
                whileHover={{ x: 3 }}
